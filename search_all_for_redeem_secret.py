"""
search_all_for_redeem_secret.py
--------------------------------
Downloads all unique chunk JS files and searches them for the word "redeemSecret"
case-insensitively to find the API implementation of the secret key submit method.
"""
...
async def scan_chunk(session: aiohttp.ClientSession, chunk_name: str):
    ...
    try:
        async with session.get(url, timeout=10) as resp:
            ...
            # Find references containing "redeemSecret"
