...
async def claim_code_callback(code: str, tweet_text: str = ""):
    ...
    logger.info(f"⚡ [Dual Claim Mode] Spotted code: '{code}'. Triggering BOTH API Secret Claim and Direct Checkout flows...")
    
    # 1. Determine target plans to try based on the text context
